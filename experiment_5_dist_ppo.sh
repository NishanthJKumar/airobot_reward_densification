...
python main.py --domain reach --algorithm ppo --reward_type dense_handcrafted --pddl_type single_subgoal --episode_steps 100 &> reach_ppo_dense.txt

echo "Running experiment... outputing here > push_ppo_dense.txt"
python main.py --domain push --algorithm ppo --reward_type dense_handcrafted --pddl_type single_subgoal --episode_steps 100 &> push_ppo_dense.txt
