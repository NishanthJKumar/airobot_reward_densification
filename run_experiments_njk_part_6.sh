...
python main.py --domain push --algorithm sac --reward_type dense_handcrafted --pddl_type grid_based --granularity 5 --episode_steps 100 &> push_sac_dense_handcrafted.txt