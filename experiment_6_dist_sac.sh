...
python main.py --domain reach --algorithm sac --reward_type dense_handcrafted --pddl_type single_subgoal --episode_steps 100 &> reach_sac_dense.txt

echo "Running experiment... outputing here > push_sac_dense.txt"
python main.py --domain push --algorithm sac --reward_type dense_handcrafted --pddl_type single_subgoal --episode_steps 100 &> push_sac_dense.txt
