...
parser.add_argument('-ts', '--training_steps', type=int, default=400000, help='Number of steps to run training for.')
parser.add_argument('-es', '--episode_steps', type=int, default=25, help='Max. number of steps in an episode.')
