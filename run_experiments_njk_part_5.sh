...
python main.py --domain reach --algorithm sac --reward_type dense_handcrafted --pddl_type grid_based --granularity 5 --episode_steps 100 &> reach_sac_dense_handcrafted.txt