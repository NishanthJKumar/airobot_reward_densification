...
class ReachingSingleSubgoalComplexClassfiers(BaseClassifiers):
    ...
    def get_path_to_domain_and_problem_files(self):
        return (os.path.abspath("envs/complex_reaching_env/single_subgoal/goal-subgoal-domain.pddl"), os.path.abspath("envs/complex_reaching_env/single_subgoal/goal-subgoal-problem.pddl"))
